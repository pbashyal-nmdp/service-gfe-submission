# -*- coding: utf-8 -*-
#
# Basemap tutorial documentation build configuration file, created by
...
project = u'service-gfe-submission'
copyright = u'2017, National Marrow Donor Program'
...
htmlhelp_basename = 'Basemaptutorialdoc'
...
man_pages = [
    ('index', 'basemaptutorial', u'Basemap tutorial Documentation',
     [u'Michael Halagan'], 1)
]
...
texinfo_documents = [
  ('index', 'Basemaptutorial', u'service-gfe-submission documentation',
...
epub_title = u'service-gfe-submission'

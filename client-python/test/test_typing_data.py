...
from swagger_client.models.typing_data import TypingData


class TestTypingData(unittest.TestCase):
    """ TypingData unit test stubs """
    ...
    def testTypingData(self):
        """
        Test TypingData
        """
        model = swagger_client.models.typing_data.TypingData()
